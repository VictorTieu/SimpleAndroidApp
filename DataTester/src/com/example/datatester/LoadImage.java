...
public class LoadImage extends ListActivity {

 //database and helper
 private DataBase picDataHelp;
 ...
 public void onCreate(Bundle savedInstanceState) {
  ...
  picDataHelp=DataBase.getInstance(this);
  ...
  String[] columns = {DataBase.ID_COL, DataBase.CREATED_COL};
